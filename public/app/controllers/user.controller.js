angular
    ...
    .controller('UserController', ['$scope', '$routeParams', '$location', 'User', 'CoreService', 'Authentication', "defaultConfig", function ($scope, $routeParams, $location, User, CoreService, Authentication,defaultConfig) 
    {
